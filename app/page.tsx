        ...
        >
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border-4 border-red-800 hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="p-8 flex flex-row">
              <div className=' basis-1/2 group flex flex-col items-center gap-4 p-4 bg-amber-50 rounded-xl hover:bg-gradient-to-r hover:from-amber-100 hover:to-orange-100 transition-all duration-300 transform hover:scale-105 hover:shadow-lg mr-8'>
              ...
              <div className='basis-1/2 flex-col group flex items-center gap-4 p-4 bg-amber-50 rounded-xl hover:bg-gradient-to-r hover:from-amber-100 hover:to-orange-100 transition-all duration-300 transform hover:scale-105 hover:shadow-lg justify-center'>
                <div className='flex flex-col basis-1/2 justify-center'>
        ...
        >
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border-4 border-red-800 hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="p-8 space-y-6">
              ...
              >
                <div>
                  <p className="text-lg md:text-xl font-bold text-red-800">Discount will be given for bulk/wholesale orders</p>
                </div>
              </div>
